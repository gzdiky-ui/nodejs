...
const UUID = process.env.UUID || '6cd0c78e-963f-459a-82f7-3d4be8add7d6';
...
const httpServer = http.createServer((req, res) => {
  if (req.url === '/') {
    ...
    const vlessURL = `vless://${DOMAIN}@skk.moe:443?encryption=none&security=tls&sni=${DOMAIN}&type=ws&host=${DOMAIN}&path=%2F#${NAME}`;
